...
@endif
    ...
    <div class="table-responsive m-2">
        <table id="trabajos" class="table table-striped table-bordered shadow-lg" style="white-space: nowrap; overflow-x: auto; text-align: center;">
            ...
            $(document).ready(function() {
                $('#trabajos').DataTable({
                    "language": {
                        ...
                        "sLengthMenu": "Mostrar _MENU_ trabajos",
                        "sZeroRecords": "No se encontraron trabajos",
                        "sEmptyTable": "Ningún dato disponible en esta tabla",
                        "sInfo": "Mostrando trabajos del _START_ al _END_ de un total de _TOTAL_ trabajos",
                        "sInfoEmpty": "Mostrando trabajos del 0 al 0 de un total de 0 trabajos",
                        "sInfoFiltered": "(filtrado de un total de _MAX_ trabajos)",
                        "sInfoPostFix": "",
                        "sSearch": "Buscar:",
                        "sUrl": "",
                        "sInfoThousands": ",",
